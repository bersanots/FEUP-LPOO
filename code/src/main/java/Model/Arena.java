...
public class Arena {
    ...
    public Arena(int w, int h, int level) {
        this.width = w;
        this.height = h;
        this.level = level;
        walls = new ArrayList<>();
    ...
    public void createWalls() {
        if (level == 1) {
            ...
            walls.add(wall_4);
            Wall wall_5 = new Wall(5, 5, 5, 19);
            walls.add(wall_5);
            Wall wall_6 = new Wall(9, 9, 2, 14);
            walls.add(wall_6);
            Wall wall_7 = new Wall(26, 26, 5, 19);
            walls.add(wall_7);
            Wall wall_8 = new Wall(22, 22, 2, 14);
            walls.add(wall_8);
            Wall wall_9 = new Wall(9, 25, 18, 18);
            walls.add(wall_9);
            Wall wall_10 = new Wall(20, 20, 2, 2);
            walls.add(wall_10);
            Wall wall_11 = new Wall(18, 18, 2, 2);
            walls.add(wall_11);
            Wall wall_12 = new Wall(16, 16, 2, 2);
            walls.add(wall_12);
        } else if (level == 2) {
            Wall wall_1 = new Wall(1, 1, 1, 20);
            walls.add(wall_1);
    ...
    public void createMonsters() {
        if (level == 1) {
            Monster monster_1 = new Monster(25, 12, false, 25);
            monsters.add(monster_1);
            Monster monster_2 = new Monster(7, 12, false, 25);
            monsters.add(monster_2);
            Monster monster_3 = new Monster(7, 7, false, 20);
            monsters.add(monster_3);
            Monster monster_4 = new Monster(7, 6, false, 15);
    ...
    public void createWizards() {
        if (level == 1) {
            Wizard wizard_1 = new Wizard(21, 2, false, 40, 5);
            wizards.add(wizard_1);
            Wizard wizard_2 = new Wizard(19, 2, false, 40, 5);
            wizards.add(wizard_2);
            Wizard wizard_3 = new Wizard(17, 2, false, 40, 5);
            wizards.add(wizard_3);
            Wizard wizard_4 = new Wizard(15, 2, false, 40, 5);
